/*
    ...
    Напишите программу, использующую функцию,
    которая осуществляет циклический сдвиг влево битов
    числа N на k позиций.
*/
...
NUMBER_FORMAT cycleShiftLeftNumber(const NUMBER_FORMAT number,
...
int main() {
    ...
    NUMBER_FORMAT resultNumber = cycleShiftLeftNumber(enteredNumber, countOfShifts);
